...
<div class="p-4 sm:ml-64">
    <div class="rounded-lg dark:border-gray-700 mt-14 flex justify-between content-start item-center">
        <h1 class="flex items-center font-bold text-[20px]">Customers</h1>
        <a href="" class="bg-gray-600 text-white  px-3 py-2 text-sm rounded-md hover:bg-gray-700">Add Product +</a>
    </div>
            ...
            <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
                <div>
                    ...
                    <div id="dropdownAction" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <div class="py-1">
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete Selected</a>
                        </div>
                    </div>
                </div>
